...
public class TicTacToeApplication {
    ...
    public static void main(String[] args) {
        ...
        while (doYouWantToPlay){
            ...
            System.out.println("Welcome to Tic Tac Toe! You are about to go against the master of Tic Tac Toe.  Are you "
            ...
            System.out.println("Do you want to play again? Enter Y if you do. Anything else if you are tired of me!");
